...
public class DBSCAN_ALGO {
    ...
    public DBSCAN_ALGO(Instances instances,double eps, int min_pts) {
        this.eps = eps;
        ...
        for(int i=0;i<clusters.size();i++){
            if(clusters.get(i).size() < min_pts){
                System.out.println("remoooooooooooove !!");
                clusters.remove(i);
                i--;
            }
        }
    ...
    private void process(){
        ...
        System.out.println("nb clusters = "+this.clusters.size());
        for(List<Instance> cluster: this.clusters){
        ...
        if(s =="mixed"){
            ...
            for (int att_idx = 0; att_idx < this.instances.numAttributes()-1; att_idx++){
                ...
                if (this.instances.attribute(att_idx).isNumeric()){
                    ...
                    System.out.println(Math.abs((Double)x.get(att_idx)-(Double)y.get(att_idx)));
                    //si l'attribut est nominal
                }else if(this.instances.attribute(att_idx).isNominal()){
    ...
    private void gravity_center(){
        System.out.println("Gravity centers");
        int nbl;
        List<Object> items ;
    ...
    private void global_gravity(){
        ...
        System.out.println("Gravity global");
    ...
    public double getIntraClassScore(){return w;}

    public double getT() {
        return t;
    }
    public double getInterClassScore(){return t;}
